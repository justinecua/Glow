...
"PO-Revision-Date: 2024-04-20 21:54+0200\n"
"Last-Translator: ctrl_alt_d\n"
...
"up%(end_link)s first."
msgstr "Si encara no heu creat un compte, llavors si us plau %(link)sregistreu-vos%(end_link)s primer."
...
msgstr[0] ""
"Hi ha un %(unused_count)s d’un total de  %(total_count)s codis de "
"recuperació disponibles."
msgstr[1] ""
"Hi ha un %(unused_count)s d’un total de  %(total_count)s codis de "
"recuperació disponibles."
...
#~ "compte d'una altra xarxa social. O %(link)sregistreu-"
#~ "vos</a> \n"
