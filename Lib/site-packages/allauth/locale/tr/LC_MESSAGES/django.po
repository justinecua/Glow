...
msgstr ""
"Bu e-postayı alıyorsunuz çünkü, %(user_display)s adlı kullanıcı, e-posta "
"adresinizi %(site_domain)s'te bir hesap kaydı oluşturmak için kullanmıştır.\n"
"\n"
"Eğer bu işlemi siz yaptıysanız veya bilginiz dahilindeyse, %(activate_url)s "
"adresine giderek doğrulama yapabilirsiniz."
...
"up%(end_link)s first."
msgstr "Zaten hesabınız var mı? O zaman lütfen %(link)sgiriş yapın%(end_link)s."
