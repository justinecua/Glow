...
"enter it soon."
msgstr "Saatsime koodi %(email_link)s. Kood aegub varsti, seega sisestaga see kiiresti."
...
"up%(end_link)s first."
msgstr "Kui sa pole veel kontot loonud, siis palun esmalt %(link)sregistreeruge%(end_link)s."
