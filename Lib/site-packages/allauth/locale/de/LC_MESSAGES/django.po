...
"PO-Revision-Date: 2024-04-20 21:27+0200\n"
...
"up%(end_link)s first."
msgstr "Du hast noch kein Konto bei uns? Dann %(link)serstelle%(end_link)s bitte zunächst eins."
...
msgstr "Du hast bereits ein Konto bei uns? Dann bitte %(link)shier entlang%(end_link)s."
